declare class $5a3b80354f588438$export$ef9b1a59e592288f {
    /**
   ...
   */ constructor(el: HTMLSelectElement, options?: {
    ...
    /** @type {HTMLSelectElement} */ el: HTMLSelectElement;
    /** @type {HTMLLabelElement | null} */ label: HTMLLabelElement | null;
    id: string;
    open: boolean;
    multiple: boolean;
    search: string;
    /** @type {Array<HTMLElement>} */ suggestions: Array<HTMLElement>;
    focusIndex: any;
    /**
   ...
   */ /**
    ...
    */ _defaultSearch(search: string, options: HTMLOptionElement[]): Promise<{
        /**
         * - if suggestion is hidden
         */
        hidden: boolean;
    ...
    _options: {
        ...
        showSelected: boolean;
        fillSuggestions: (search: string, options: HTMLOptionElement[]) => Promise<{
            /**
             * - if suggestion is hidden
             */
            hidden: boolean;
 ...
 */ currentOptions: Array<HTMLOptionElement>;
   ...
   */ selectOptionSilently(value: any): void;
    ...
    list: HTMLDivElement;
    /** @type {HTMLInputElement | null} */ input: HTMLInputElement | null;
...
declare var $5a3b80354f588438$export$2e2bcd8739ae039: typeof $5a3b80354f588438$export$ef9b1a59e592288f;
